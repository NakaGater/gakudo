    ...
    >
      <div className="mx-auto max-w-6xl px-4 py-6 sm:px-10">
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-[1.5fr_1fr_1fr]">
          ...
          {/* Links */}
          <div>
            <h3 className="mb-1.5 text-[13px] font-bold font-story text-white">リンク</h3>
            <ul className="space-y-0.5 text-[11px]">
              <li>
                <Link href="/" className="transition-colors hover:text-cr-yellow no-underline">
                  ホーム
                </Link>
              </li>
              <li>
                <Link href="/about" className="transition-colors hover:text-cr-yellow no-underline">
                  施設紹介
                </Link>
              </li>
              <li>
                <Link
                  href="/daily-life"
                  className="transition-colors hover:text-cr-yellow no-underline"
                >
                  日々の生活
                </Link>
              </li>
              ...
              <li>
                <Link href="/faq" className="transition-colors hover:text-cr-yellow no-underline">
                  Q&A
                </Link>
              </li>
              <li>
                <Link href="/login" className="transition-colors hover:text-cr-yellow no-underline">
                  保護者ログイン
                </Link>
              </li>
            </ul>
          ...
          {/* Contact */}
          <div>
            <h3 className="mb-1.5 text-[13px] font-bold font-story text-white">お問い合わせ</h3>
      ...
      {/* Cat mascot */}
      <span
        className="absolute bottom-3 right-6 text-xl opacity-40 -rotate-[8deg]"
        aria-hidden="true"
      >
        😺
      </span>

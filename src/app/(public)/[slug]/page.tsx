...
export default async function SitePage({ params }: PageProps) {
  ...
  if (slug === "enrollment") {
    return <EnrollmentPage title={page.title} content={page.content} metadata={page.metadata} />;
  }
...
function EnrollmentPage({ title, content, metadata }: { title: string; content: string; metadata: Record<string, unknown> }) {

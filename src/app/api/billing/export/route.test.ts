...
describe('GET /api/billing/export', () => {
  ...
  it('returns CSV with correct headers on success', async () => {
    ...
    mockBillsSelect.mockResolvedValue({
      data: [
        { id: '1', total_amount: 50000, year_month: '2025-01', total_extended_minutes: 100, status: 'confirmed', children: { name: 'Child 1' } },
        { id: '2', total_amount: 60000, year_month: '2025-01', total_extended_minutes: 120, status: 'confirmed', children: { name: 'Child 2' } },
      ],
      error: null,
    })

    const csvContent = '児童名,対象月,延長時間(分),合計金額,ステータス\nChild 1,2025-01,100,50000,確定済み\nChild 2,2025-01,120,60000,確定済み'
